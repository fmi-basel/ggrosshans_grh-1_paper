...
setwd("~/Milou - Projects/GRH-1/SWI/2019-08-28")
Molt <- read.csv('2019-08-28 MoltAnnotation.csv')
GFP <- read.csv('Results T07/2019-08-28 GFP intensities.csv')
