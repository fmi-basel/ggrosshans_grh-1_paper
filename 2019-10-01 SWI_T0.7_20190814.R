...
setwd("~/Milou - Projects/GRH-1/SWI/2019-08-14")
Molt <- read.csv('2019-08-14 MoltAnnotation.csv')
GFP <- read.csv('Results_T07/2019-08-14 GFP intensities T07.csv')
...
matplot(t(GFP_strain1_eth$gfp_M2exit), ylim=c(0,1000), type='l', lty=1, col='grey', main=GFP_strain1_eth$name,xaxt = 'n', ylab='background subtracted GFP intensity', xlab='time after M2 exit (h)'); matplot(t(GFP_strain1_eth$gfp_molt), type='l', lty=2, col=alpha('blue',0.5), add=TRUE); lines(GFP_strain1_eth$meanGFP);  lines(GFP_strain1_eth$upperGFP, col='red', lty=2); lines(GFP_strain1_eth$lowerGFP, col='red', lty=2); axis(1, at = 1:tp, labels = colnames(GFP_strain1_eth$gfp), cex.axis = 0.7) 
matplot(t(GFP_strain1_aux$gfp_M2exit), ylim=c(0,1000), type='l', lty=1, col='grey', main=GFP_strain1_aux$name,xaxt = 'n', ylab='background subtracted GFP intensity', xlab='time after M2 exit (h)'); matplot(t(GFP_strain1_aux$gfp_molt_phenotype), type='l', lty=2, col=alpha('blue',0.5), add=TRUE); lines(GFP_strain1_aux$meanGFP);  lines(GFP_strain1_aux$upperGFP, col='red', lty=2); lines(GFP_strain1_aux$lowerGFP, col='red', lty=2); axis(1, at = 1:tp, labels = colnames(GFP_strain1_aux$gfp), cex.axis = 0.7) 
