...
Molt <- read.csv('Data/2019-08-23 moltAnnotation.csv')
GFP33 <- read.csv('Data/2019-08-23 Intensity_worm33.csv', row.names = 1)
GFP34 <- read.csv('Data/2019-08-23 Intensity_worm34.csv', row.names = 1)
GFP60 <- read.csv('Data/2019-08-23 Intensity_worm60.csv', row.names = 1)
tp <- 361
strain1 <- 'HW2603'
